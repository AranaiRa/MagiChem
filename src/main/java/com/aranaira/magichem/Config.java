...
public class Config
{
    ...
    private static final ForgeConfigSpec.IntValue ALEMBIC_GRIME_ON_SUCCESS = BUILDER
            ...
            .defineInRange("alembicGrimeOnSuccess", 10, 0, Integer.MAX_VALUE);

    private static final ForgeConfigSpec.IntValue ALEMBIC_GRIME_ON_FAILURE = BUILDER
            .comment("The amount of additional Grime generated by a dram of materia that fails to distill. This value is added to the grime on success value.")
            .defineInRange("alembicGrimeOnFailure", 75, 0, Integer.MAX_VALUE);
