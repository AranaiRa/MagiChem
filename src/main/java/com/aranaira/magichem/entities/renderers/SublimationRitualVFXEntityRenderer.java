...
public class SublimationRitualVFXEntityRenderer extends EntityRenderer<SublimationRitualVFXEntity> {
    public SublimationRitualVFXEntityRenderer(Context pContext) {
        super(pContext);
    }
