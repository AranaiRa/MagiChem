...
public class ActuatorFireScreen extends AbstractContainerScreen<ActuatorFireMenu> {
    ...
    private void initializePowerLevelButtons() {
        ...
        this.addRenderableWidget(new ImageButton(this.leftPos + 202, this.topPos + 12, 11, 11, 97, 174, TEXTURE, button -> {
    ...
    protected void renderBg(GuiGraphics gui, float partialTick, int mouseX, int mouseY) {
        ...
        //Tier blocks
        gui.blit(TEXTURE, x + 36, y + 19, 202, 0, 8, menu.getTier() <= 3 ? 18 : (menu.getTier() == 4 ? 9 : 0));
    }
    ...
    protected void renderTooltip(GuiGraphics gui, int mouseX, int mouseY) {
        ...
        if(mouseX >= x+ TOOLTIP_SMOKE_X && mouseX <= x+ TOOLTIP_SMOKE_X + TOOLTIP_SMOKE_W &&
            ...
            tooltipContents.add(Component.empty()
                    ...
                    .append(Component.literal(menu.blockEntity.getSmokeInTank() + " / " + ServerConfig.infernoEngineTankCapacity).withStyle(ChatFormatting.DARK_AQUA))
