    ...
    protected void renderTooltip(GuiGraphics gui, int mouseX, int mouseY) {
        ...
        if(mouseX >= x+TOOLTIP_WATER_X && mouseX <= x+TOOLTIP_WATER_X+TOOLTIP_WATER_W &&
            ...
            tooltipContents.add(Component.empty()
                    ...
                    .append(Component.literal(menu.blockEntity.getWaterInTank() + " / " + ServerConfig.delugePurifierTankCapacity).withStyle(ChatFormatting.DARK_AQUA))
        ...
        if(mouseX >= x+TOOLTIP_STEAM_X && mouseX <= x+TOOLTIP_STEAM_X+TOOLTIP_STEAM_W &&
            ...
            tooltipContents.add(Component.empty()
                    ...
                    .append(Component.literal(menu.blockEntity.getSteamInTank() + " / " + ServerConfig.delugePurifierTankCapacity).withStyle(ChatFormatting.DARK_AQUA))
                    .append(Component.literal("  ")
                            .append(Component.literal("( ").withStyle(ChatFormatting.DARK_GRAY))
        ...
        //Consumption rules
        if(mouseX >= x+193 && mouseX <= x+193+57 &&
