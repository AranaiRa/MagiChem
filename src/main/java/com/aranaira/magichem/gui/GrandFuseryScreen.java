...
public class GrandFuseryScreen extends AbstractContainerScreen<GrandFuseryMenu> {
    ...
    public GrandFuseryScreen(GrandFuseryMenu menu, Inventory inventory, Component component) {
    ...
    private void initializeRecipeSelectorButtons(){
        ...
        for(int y=0; y<5; y++) {
            for(int x=0; x<3; x++) {
                recipeSelectButtons[c] = new ButtonData(this.addRenderableWidget(new GrandFuseryButtonRecipeSelector(
                    ...
                    query.setActiveRecipe(((GrandFuseryButtonRecipeSelector) button).getArrayIndex());
                })), x*18 - 77, y*18 + 22);
                c++;
            }
        }
    ...
    public static List<Rect2i> getGuiExtraAreas(GrandFuseryScreen screen) {
