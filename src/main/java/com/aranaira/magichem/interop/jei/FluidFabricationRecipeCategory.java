...
public class FluidFabricationRecipeCategory implements IRecipeCategory<FluidDistillationFabricationRecipe> {
    public static final ResourceLocation UID = new ResourceLocation(MagiChemMod.MODID, "fluid_fabrication");
    ...
    public FluidFabricationRecipeCategory(IGuiHelper helper) {
        this.background = helper.createDrawable(TEXTURE, 96, 0, 96, 110);
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(ItemRegistry.DUMMY_PROCESS_FLUID_FABRICATION.get()));
    }

    @Override
    public RecipeType<FluidDistillationFabricationRecipe> getRecipeType() {
        return JEIPlugin.FLUID_FABRICATION_TYPE;
    }

    @Override
    public Component getTitle() {
        return Component.translatable("jei.magichem.fluid_fabrication");
    }
