...
import com.aranaira.magichem.entities.ThrownSonicBombEntity;
...
public class SonicBombItem extends Item {
    public SonicBombItem(Properties pProperties) {
        super(pProperties);
    }
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(
                Component.translatable("tooltip.magichem.sonic_bomb")
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pHand) {
        ...
        if (!pLevel.isClientSide) {
            ThrownSonicBombEntity tte = new ThrownSonicBombEntity(EntitiesRegistry.THROWN_SONIC_BOMB_ENTITY.get(), pLevel);
