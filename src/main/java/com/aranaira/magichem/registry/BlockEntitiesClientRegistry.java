...
public class BlockEntitiesClientRegistry {
    ...
    public static void onClientSetupEvent(FMLClientSetupEvent event) {
        ...
        BlockEntityRenderers.register(BlockEntitiesRegistry.MATERIA_JAR_QUAD_BE.get(), MateriaJarQuadBlockEntityRenderer::new);
    ...
    public static void onRegisterBlockEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerBlockEntityRenderer(BlockEntitiesRegistry.GRAND_CENTRIFUGE_BE.get(), GrandCentrifugeBlockEntityRenderer::new);
        event.registerBlockEntityRenderer(BlockEntitiesRegistry.GRAND_DISTILLERY_BE.get(), GrandDistilleryBlockEntityRenderer::new);
        event.registerBlockEntityRenderer(BlockEntitiesRegistry.GRAND_FUSERY_BE.get(), GrandFuseryBlockEntityRenderer::new);
        ...
        event.registerBlockEntityRenderer(BlockEntitiesRegistry.ACTUATOR_ENDER_BE.get(), ActuatorEnderBlockEntityRenderer::new);
        ...
        event.registerBlockEntityRenderer(BlockEntitiesRegistry.PRIME_AGGREGATOR_BE.get(), PrimeAggregatorBlockEntityRenderer::new);
        event.registerBlockEntityRenderer(BlockEntitiesRegistry.BOSS_TROPHY_BE.get(), BossTrophyBlockEntityRenderer::new);
    }
}
