...
public class BlockRegistry {
    ...
    public static final RegistryObject<PrimeAggregatorBlock> PRIME_AGGREGATOR = registerBlock("prime_aggregator",
            () -> new PrimeAggregatorBlock(BlockBehaviour.Properties.of()
                    .strength(3.0f).noOcclusion().isSuffocating((pState, pLevel, pPos) -> false))
    );
    ...
    public static final RegistryObject<Block> GNOSTIC_ORB = registerBlock("gnostic_orb",
            () -> new GnosticOrbBlock(BlockBehaviour.Properties.of()
                    .strength(0.75f).noOcclusion().isSuffocating((pState, pLevel, pPos) -> false))
    );
    ...
    public static final RegistryObject<Block> COVETOUS_COFFER = registerBlock("covetous_coffer",
            () -> new CovetousCofferBlock(BlockBehaviour.Properties.of()
                    .strength(0.75f).noOcclusion().isSuffocating((pState, pLevel, pPos) -> false))
    );
