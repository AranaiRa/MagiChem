...
public class MenuRegistry {
    ...
    public static final RegistryObject<MenuType<ActuatorEnderMenu>> ACTUATOR_ENDER_MENU =
            registerMenuType(ActuatorEnderMenu::new, "actuator_ender");
    ...
    public static final RegistryObject<MenuType<MateriaReflectorMenu>> MATERIA_REFLECTOR_MENU =
            registerMenuType(MateriaReflectorMenu::new, "materia_reflector");
    ...
    public static final RegistryObject<MenuType<NourishingCenserMenu>> NOURISHING_CENSER_MENU =
            registerMenuType(NourishingCenserMenu::new, "nourishing_censer");
