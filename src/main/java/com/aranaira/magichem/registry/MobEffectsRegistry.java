...
public class MobEffectsRegistry {
    ...
    public static final RegistryObject<MobEffect> CHAINSPELL = EFFECTS.register("chainspell", () -> new SimpleEffect(MobEffectCategory.NEUTRAL, 0xff3139d8));
    public static final RegistryObject<MobEffect> REGAL_TWILIGHT = EFFECTS.register("regal_twilight", () -> new RegalTwilightEffect(MobEffectCategory.NEUTRAL, 0xff27753b));
    public static final RegistryObject<MobEffect> GOLDEN_RESURGENCE = EFFECTS.register("golden_resurgence", GoldenResurgenceEffect::new);
