...
public class OccultismFluidRegistry {
    ...
    //SILVER
    public static final RegistryObject<FluidType> LIQUEFACTED_SILVER_FLUID_TYPE = FLUID_TYPES.register("liquefacted_silver_fluid_type", () ->
            new FluidType(FluidType.Properties.create().descriptionId("liquefacted_silver_fluid_type")
    ...
    //Iesnium
    public static final RegistryObject<FluidType> LIQUEFACTED_IESNIUM_FLUID_TYPE = FLUID_TYPES.register("liquefacted_iesnium_fluid_type", () ->
            new FluidType(FluidType.Properties.create().descriptionId("liquefacted_iesnium_fluid_type")
                    .canExtinguish(true).canConvertToSource(false)
                    .supportsBoating(true).canHydrate(false).viscosity(0).canPushEntity(false)
                    .sound(SoundActions.BUCKET_FILL, SoundEvents.BUCKET_FILL)
                    .sound(SoundActions.BUCKET_EMPTY, SoundEvents.BUCKET_EMPTY)
